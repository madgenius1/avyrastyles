...
export default function WhyAvyra() {
    return (
        <main className="lg:py-4 py-4 ">
            <div className="flex lg:flex-row md:flex-row flex-col gap-4 lg:gap-6 lg:px-12 md:p-6 p-4 w-full lg:h-[70vh] ">
                <div className="lg:w-1/2 w-full lg:h-[40vh] md:h-[40vh] h-[40vh] flex flex-col gap-4 ">
                    <div className="">
                        <h2 className={`${cormorant.className} text-start text-gray-900 font-bold lg:text-4xl md:text-3xl text-xl leading-relaxed uppercase`}>
                    ...
                    <div className="flex flex-col items-start gap-4 py-4 ">
                        {things.map((item, index) => (
                            <div key={index} className="flex items-center gap-3">
                                {item.icon}
                                <span className={`text-gray-900 lg:text-xl text-md`}>
                                    {item.text}
                                </span>
                            </div>
                        ))}
